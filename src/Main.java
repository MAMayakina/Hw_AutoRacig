...
public class Main {
    public static void main(String[] args) {
       ...
       /* DriverB<Car> driver1 = new DriverB<Car>("Владимир", 10);
        ...
        System.out.println();
        System.out.println("*** Проверка метода - определить тип транспорта");
        System.out.println(car1.getTypeOfTransport());
        System.out.println(truck1.getTypeOfTransport());
        System.out.println( bus1.getTypeOfTransport());
